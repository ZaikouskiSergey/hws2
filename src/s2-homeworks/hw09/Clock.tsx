...
function Clock() {
    ...
    const stringCurDate = date?.toLocaleDateString()
    const stringDate = stringCurDate.split('/').join('.') || <br/> // день.месяц.год (01.02.2022) // пишут студенты, варианты 01.02.0123/01.02.-123/01.02.12345 не рассматриваем
