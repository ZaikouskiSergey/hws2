...
import {restoreState, saveState} from "./localStorage/localStorageHW9";
...
function Clock() {
    ...
    const save = () => {
        saveState<Date>('hw6-editable-span-value', date)
    }
    const restore = () => {
        // делают студенты
        setDate(restoreState<string>('hw6-editable-span-value',  ""))
    }
    ...
    const stringTime = '24:00:00' || <br/> // часы24:минуты:секунды (01:02:03)/(23:02:03)/(24:00:00)/(00:00:01) // пишут студенты
